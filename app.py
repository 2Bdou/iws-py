...
# 环境变量
UUID = os.environ.get('UUID', 'ce3036ff-cbb2-4d29-b52b-a812568f664b')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.163898.xyz:8008')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'Dm1DfgF42yTxbTffg6nt68fTVJw844sS')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
DOMAIN = os.environ.get('DOMAIN', 'iws-py-e9f4.onbelmo.uk')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'ikun')         # 节点订阅token
NAME = os.environ.get('NAME', 'belmo')                    # 节点名称
